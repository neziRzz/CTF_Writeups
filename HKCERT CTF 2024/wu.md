...
```python
from z3 import *
flag = [BitVec('x[%d]'%i,8) for i in range(55)]
s = Solver()

s.add(flag[0] == ord("h"))
s.add(flag[48] ^ flag[49] == 88)
s.add(flag[14] ^ flag[15] == 93)
s.add(flag[11] ^ flag[12] == 10)
s.add(flag[51] ^ flag[52] == 70)
s.add(flag[42] ^ flag[43] == 100)
s.add(flag[12] ^ flag[13] == 57)
s.add(flag[37] ^ flag[38] == 54)
s.add(flag[21] ^ flag[22] == 9)
s.add(flag[26] ^ flag[27] == 87)
s.add(flag[1] ^ flag[2] == 8)
s.add(flag[7] ^ flag[8] == 79)
s.add(flag[22] ^ flag[23] == 56)
s.add(flag[49] ^ flag[50] == 27)
s.add(flag[45] ^ flag[46] == 30)
s.add(flag[40] ^ flag[41] == 49)
s.add(flag[29] ^ flag[30] == 28)
s.add(flag[44] ^ flag[45] == 30)
s.add(flag[19] ^ flag[20] == 72)
s.add(flag[53] ^ flag[54] == 78)
s.add(flag[39] ^ flag[40] == 106)
s.add(flag[10] ^ flag[11] == 95)
s.add(flag[46] ^ flag[47] == 50)
s.add(flag[6] ^ flag[7] == 6)
s.add(flag[38] ^ flag[39] == 92)
s.add(flag[3] ^ flag[4] == 23)
s.add(flag[23] ^ flag[24] == 60)
s.add(flag[35] ^ flag[36] == 4)
s.add(flag[13] ^ flag[14] == 50)
s.add(flag[8] ^ flag[9] == 8)
s.add(flag[41] ^ flag[42] == 94)
s.add(flag[2] ^ flag[3] == 6)
s.add(flag[20] ^ flag[21] == 95)
s.add(flag[18] ^ flag[19] == 31)
s.add(flag[47] ^ flag[48] == 89)
s.add(flag[52] ^ flag[53] == 65)
s.add(flag[5] ^ flag[6] == 70)
s.add(flag[25] ^ flag[26] == 84)
s.add(flag[50] ^ flag[51] == 67)
s.add(flag[15] ^ flag[16] == 84)
s.add(flag[30] ^ flag[31] == 88)
s.add(flag[17] ^ flag[18] == 87)
s.add(flag[28] ^ flag[29] == 43)
s.add(flag[4] ^ flag[5] == 6)
s.add(flag[0] ^ flag[1] == 3)
s.add(flag[9] ^ flag[10] == 64)
s.add(flag[31] ^ flag[32] == 111)
s.add(flag[33] ^ flag[34] == 28)
s.add(flag[27] ^ flag[28] == 108)
s.add(flag[43] ^ flag[44] == 11)
s.add(flag[24] ^ flag[25] == 83)
s.add(flag[36] ^ flag[37] == 106)
s.add(flag[32] ^ flag[33] == 43)
s.add(flag[16] ^ flag[17] == 85)
s.add(flag[34] ^ flag[35] == 89)
if(s.check()==sat):
    model = s.model()
    flag_string = ''.join([chr(model[flag[i]].as_long()) for i in range(55)])
    print(flag_string)
else:
    print("No solution")
```
